...
public class SharedPreferenceUtils {
    ...
    public static final String FILE_NAME = "meiying_share_data";

    private static final SimpleArrayMap<String, SharedPreferenceUtils> SP_UTILS_MAP = new SimpleArrayMap<>();
    private SharedPreferences sp;

    private SharedPreferenceUtils(Context context, final String spName, final int mode) {
    ...
    public static SharedPreferenceUtils getInstance(Context context, final int mode) {
    ...
    public static SharedPreferenceUtils getInstance(Context context, String spName, final int mode) {
        if (isSpace(spName)) spName = "spUtils";
        SharedPreferenceUtils spUtils = SP_UTILS_MAP.get(spName);
        if (spUtils == null) {
            spUtils = new SharedPreferenceUtils(context, spName, mode);
    ...
    public static void put(Context context, String key, Object object) {
        getInstance(context).put(key, (boolean) object);
    }
